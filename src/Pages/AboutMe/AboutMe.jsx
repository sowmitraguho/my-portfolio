...
const AboutMe = () => {
  ...
  return (
    <div>
      <section
        id="about"
        className="relative py-20 px-6 md:px-20 transition-colors duration-500 overflow-hidden flex flex-col md:flex-row items-center justify-between gap-16"
        style={{
      ...
      >
        ...
        >
          ...
          <div className="absolute -inset-1 rounded-xl bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 animate-rotate-border w-3/4" />

          {/* Glow effect (optional) */}
          <div className="absolute -inset-1 rounded-xl bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 blur-lg opacity-70 animate-pulse-glow w-3/4" />

          {/* Static image container */}
          <div className="relative rounded-xl overflow-hidden shadow-lg ring-1 ring-gray-300 dark:ring-gray-700 w-3/4">
            <img
              src={myPhoto}
              alt="Sowmitra Guha"
        ...
        >
          <h2 className="text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400 my-6 ">
            About Me
          </h2>

          <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 leading-relaxed mb-6 text-justify">
